...
export default () => (
    <Box $lineHeight={1.7}>
        Your privacy is important to us. It is Typesafe's policy to respect your
        privacy regarding any information we may collect from you across our
        website, https://typesafe.blog, and other sites we own and operate. We
        ...
        provide you with some of your desired services. Your continued use of
        our website will be regarded as acceptance of our practices around
        privacy and personal information. If you have any questions about how we
        handle user data and personal information, feel free to contact us. This
        policy is effective as of 20 May 2020. You can contact us at:
        eyk@typesafe.blog
    </Box>
);
